...
const ContactForm = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(
      "cats1337", // Your SERVICE ID here (from emailjs.com)?
      "portfolio", // Your TEMPLATE ID here (from emailjs.com)?
      e.target, // The form
      "vuguI_5Be5iVhQQoI" // Your API KEY here (from emailjs.com)?
    )
    .then(
      (result) => {
...
return (
  ...
  >
    <div>
      ...
      >
        <Typewriter words={["GET IN TOUCH!"]} loop={false} />
        &nbsp;
      </h2>
    </div>
